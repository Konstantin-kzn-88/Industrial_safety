...
class Substance:
    ...
    sulfur = 10
    resins = 10  # смолы
    asphalt = 15  # асфальтены
    paraffin = 20
    viscosity = 33
    hydrogen_sulfide = 0.07  # сероводород
...
class Dangerous_object:
    ...
    def __init__(self, substance: Union[Substance]):
        self.list_device = []  # инициализируем пустой список оборудования
        self.sub = substance  # инициализируем модельное вещество
...
if __name__ == '__main__':
    ...
    sub = Substance()
    start_obj = Dangerous_object(sub)
    # Изменим параметр вещества
    sub.density = 860
    # 2. Инициализируем оборудование
    dev1 = Device()
    # Изменим параметр оборудования
    dev1.pressure = 0.3
    # Добавим оборудование в список
    start_obj.append_device(dev1)
