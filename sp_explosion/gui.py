...
# local import
from sp_explosion import class_sp_explosion as expl
...
class Calc_GUI(QtWidgets.QWidget):
    def __init__(self, parent=None) -> None:
        ...
        self.table_header = 0  # установлена ли шабка для талицы
        self.header = ['Масса вещества, кг', 'Теплота сгорания, кДж/кг', 'Коэф.участия, -']
    ...
    def btn_calc_func(self) -> None:
        ...
        if self.min_gui.write_excel.isChecked():
            ...
            result = expl.Explosion().explosion_class_zone(mass = val[0], heat_of_combustion= val[1], z= val[2])
            # запишем  в excel
            ...
            expl.Explosion().explosion_plot(mass = val[0], heat_of_combustion= val[1], z= val[2])
